    ...
    objects:[
      ...
      },
      {
        ...
        images:[
          ...
          {
            url: require('../assets/images/7/8.jpg'),
            source: '',
            description: 'Швейная мастерская'
          },
          {
        ...
        comments:[
          {
            text:'Была парихмахерская, слева в торце здания от главного входа в "Дом торговли": мужской и женский зал, маникюр. И ремонт обуви был. Всё было.',
            author: '<a href="https://vk.com/id562641092" target="_blank">Татьяна Ражева</a>'
          },
          {
            text:'В то время (без асфальта, и по сугробам) было очень удобно, все в одном здании: и продуктовый магазин, и одежда (на втором этаже слева), и столовая, и кулинария (внизу), и хлебный. Мастера отличные, обслужат на 100%. Удобно и быстро.',
            author: '<a href="https://vk.com/id562641092" target="_blank">Татьяна Ражева</a>'
          },
        ]
      },
      ...
      },
      {
        id: 21,
        title: 'Молокозавод',
        mapUrl: '<iframe src="https://yandex.ru/map-widget/v1/-/CCUn4WgE9A" width="100%" height="400" frameborder="1" allowfullscreen="true" style="position:relative;"></iframe>',
        description: '',
        images:[
          {
